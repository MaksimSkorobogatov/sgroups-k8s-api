...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		BootstrapToken{}.OpenAPIModelName():                               schema_pkg_apis_sgroups_v1alpha1_BootstrapToken(ref),
...
func schema_pkg_apis_sgroups_v1alpha1_BootstrapToken(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BootstrapToken is the hosts/bootstrap-token response: a short-lived enrollment JWT for the host.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"token": {
						SchemaProps: spec.SchemaProps{
							Description: "Token is the signed bootstrap JWT.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
